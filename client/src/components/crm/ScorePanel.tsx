...
const SCORE_DESCRIPTIONS = {
  contribution: {
    ...
    description: "Что этот человек уже даёт вам. Финансовый критерий имеет вес 50% (макс. 7.5 баллов), остальные 4 критерия — по 12.5% каждый (макс. ~1.9 балла каждый). Класс: A (12+), B (8-11), C (4-7), D (0-3)."
  },
  potential: {
