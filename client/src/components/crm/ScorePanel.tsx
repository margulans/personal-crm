...
const SCORE_DESCRIPTIONS = {
  contribution: {
    ...
    description: "Что этот человек уже даёт вам: финансовая польза, помощь сетью контактов, доверие и репутация. Каждый критерий от 0 до 3 баллов. Класс: A (7-9), B (5-6), C (2-4), D (0-1)."
  },
  potential: {
