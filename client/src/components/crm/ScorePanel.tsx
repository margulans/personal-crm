...
const SCORE_DESCRIPTIONS = {
  contribution: {
    ...
    description: "Что этот человек уже даёт вам: финансовая польза, помощь сетью контактов, тактическая поддержка, стратегическое влияние и лояльность. Каждый критерий от 0 до 3 баллов. Класс: A (12-15), B (8-11), C (4-7), D (0-3)."
  },
  potential: {
